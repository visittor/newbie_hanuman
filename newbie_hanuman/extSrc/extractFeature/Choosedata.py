...
def ReadDataset(datasetName,feature):
	...
	Featureslist = Features_panda.values
	Classlabeslist = Classlabels_panda.values.reshape(-1)

	# return Features_panda,Classlabels_panda,Data_include
	return Featureslist,Classlabeslist



if __name__ == "__main__":
	FeatureData,ClassData, = ReadDataset('TestData_1.csv','ph')